...
<f:view>
	...
	<center><a4j:form id="form">
		<rich:panel header="Cidade"
			style="width: 550px;  position: absolute; left: 415px; top: auto;">
			...
			<rich:dataTable id="listaCidade"
				value="#{cidadeController.cidadeList}" var="list"
				...
				<rich:column sortBy="#{list.estado.uf}" filterBy="#{list.estado.uf}"
					filterEvent="onkeyup">
					<f:facet name="header">
						<h:outputText value="Estado" />
					</f:facet>
					<h:outputText value="#{list.estado.uf}" />
				</rich:column>
				<rich:column>
					<f:facet name="header">
						<h:outputText value="Editar" />
					</f:facet>
					<a4j:commandLink action="#{cidadeController.carregar}"
						reRender="listaCidade" ajaxSingle="true">
						<h:graphicImage value="../images/edit.gif" style="border:0"
							id="editar"/>
						<f:setPropertyActionListener value="#{list.codigo}"
							target="#{cidadeController.cidade.codigo}" />
					</a4j:commandLink>
				...
				<tbody>
					<tr>
						<td align="center" width="50%"><a4j:commandButton value="Sim"
							ajaxSingle="true" action="#{cidadeController.excluir}"
							oncomplete="#{rich:component('deletePanel')}.hide();"
							reRender="listaCidade, form" /></td>
