...
<f:view>
	...
	<center><a4j:form id="form">
		<rich:panel header="Marca"
			...
			<rich:dataTable id="listaMarca"
				value="#{marcaController.marcaList}" var="list" width="400px"
				...
				<rich:column>
					...
					<a4j:commandLink action="#{marcaController.carregar}"
						reRender="listaMarca" ajaxSingle="true">
						<h:graphicImage value="../images/edit.gif" style="border:0"
							id="editar" />
						<f:setPropertyActionListener value="#{list.codigo}"
							target="#{marcaController.marca.codigo}" />
					</a4j:commandLink>
				...
				<tbody>
					<tr>
						<td align="center" width="50%"><a4j:commandButton value="Sim"
							ajaxSingle="true" action="#{marcaController.excluir}"
