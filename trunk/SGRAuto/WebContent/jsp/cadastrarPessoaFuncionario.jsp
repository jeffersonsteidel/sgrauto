...
<f:view>
	...
	<center><a4j:form id="form">
		<rich:panel header="Pessoa - Funcionário"
			style="width: 700px; position: absolute; left: 330px; top: auto;">
			...
			<h:panelGrid columns="4">
				...
				<h:inputText required="true"
					requiredMessage="Campo Remuneração obrigatório!"
					converterMessage="Campo Remuneração inválido"
				...
				<rich:calendar required="true"
					value="#{pessoaController.pessoa.dataEntrada}" locale=""
				...
				<h:outputText value="Data Saída: "
					rendered="#{pessoaController.pessoa.dataSaida != null}" />
				<h:inputText value="#{pessoaController.pessoa.dataSaida}"
					rendered="#{pessoaController.pessoa.dataSaida != null}" size="15"
				...
				<h:inputText required="true"
					...
					value="#{pessoaController.pessoa.login}" size="25" maxlength="20"></h:inputText>
				<h:outputText value="Senha: "
					rendered="#{pessoaController.pessoa.senha == null}" />
				<h:inputSecret required="true"
					rendered="#{pessoaController.pessoa.senha == null}"
					requiredMessage="Campo Senha obrigatório!"
					value="#{pessoaController.pessoa.senha}" size="25" maxlength="12"></h:inputSecret>
				<h:outputText value="Cliente: " />
				<h:selectBooleanCheckbox
					value="#{pessoaController.pessoa.indCliente}"></h:selectBooleanCheckbox>
				<h:outputText value="Gerente: " />
				<h:selectBooleanCheckbox
					value="#{pessoaController.pessoa.indGerente}"></h:selectBooleanCheckbox>
			</h:panelGrid>
